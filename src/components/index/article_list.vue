        ...
        <li v-for="item in data.article_list" :key="item.id">
          ...
          <div class="right">
            ...
            <div class="article_info">
              ...
              <span><i class="fa fa-thumbs-up"></i>{{ item.like_counts }}</span>
              <span><i class="fa fa-eye"></i>{{ item.view_counts }}</span>
              <span><i class="fa fa-comments"></i>{{ item.comment_counts }}</span>
              <span><i class="fa fa-star-o"></i>{{ item.star_counts }}</span>
            </div>
          </div>
        </li>
      </ul>
...
async function getData() {
  ...
  console.log(res)
  data.article_list = res.data
  data.total = res.paging.total
}
