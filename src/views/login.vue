  ...
  <div class="login_bg">
    <a-modal title="用户注册" v-model:visible="userRegisterVisible">
      ...
      <template #footer>
        ...
        <a-button type="primary" @click="userReguster">注册</a-button>
      </template>
      ...
      <div class="login_main">
        ...
        <div class="login_form">
          <div class="login_form_item">
            <a-input placeholder="用户名" v-model:value="data.username">
        ...
        <div class="login_other">第三方登录</div>
        <div class="login_other_icons">
          <img src="../../public/icon/qq_logo.png" @click="getQQLogin" class="login_other_icon" alt="">
        </div>
      </div>
    </div>
  </div>
...
async function sendEmailCode() {
  ...
  let res = await userRegisterApi({email:formState.email,nickname:formState.nickname,username:formState.username})
  if (res.code !== 0) {
...
async function emailLogin() {
  ...
  let userInfo = {
    ...
    role: 2, // 0-未登录（默认） 1-管理员 2-普通用户 3-游客
    user_id: res.data.id,
