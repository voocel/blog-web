<template>
  <div class="base_view article_view">
    ...
    <div style="height: 320px">
      <Banner class="article_title" :url="data.banner_url" :slogan="data.title" :abstract="data.abstract"
        is-article v-if="data.title !== ''"></Banner>
    </div>
        ...
        <article>
          <div class="article_head">
            ...
            <div class="info">
              ...
              <span>作者：{{ data.user_nickname }}</span>
            </div>
            <div class="tag">
          ...
          <ArticleCommentList style='margin-top: 20px'></ArticleCommentList>
        </article>
        <aside>
...
import ArticleCommentList from "@/components/article_comment_list.vue";
