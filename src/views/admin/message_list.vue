...
function onFilter() {
  bTable.value.ExportList({level: level.value})
}
...
const data = reactive({
  columns: [
    ...
    {title: '发送人昵称', dataIndex: 'send_user_nickname', key: 'send_user_nickname'},
    {title: '发送人头像', dataIndex: 'send_user_avatar', key: 'send_user_avatar'},
    {title: '内容', dataIndex: 'content', key: 'content'},
    {title: '接收人昵称', dataIndex: 'rev_user_nickname', key: 'rev_user_nickname'},
